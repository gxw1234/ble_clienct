/****************************************************************************
** Meta object code from reading C++ file 'caselineinputdialog.h'
**
...
#error "The header file 'caselineinputdialog.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 12, 13), // "dataSubmitted"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 4), // "data"
QT_MOC_LITERAL(4, 32, 11) // "onOkClicked"

    },
    "InputDialog\0dataSubmitted\0\0data\0"
    "onOkClicked"
};
...
void InputDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dataSubmitted((*reinterpret_cast< const QMap<QString,QVariant>(*)>(_a[1]))); break;
        ...
        {
            using _t = void (InputDialog::*)(const QMap<QString,QVariant> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&InputDialog::dataSubmitted)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void InputDialog::dataSubmitted(const QMap<QString,QVariant> & _t1)
{
