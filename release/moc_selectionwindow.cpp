...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SelectionWindow_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SelectionWindow_t qt_meta_stringdata_SelectionWindow = {
    {
QT_MOC_LITERAL(0, 0, 15), // "SelectionWindow"
QT_MOC_LITERAL(1, 16, 13), // "selectionMade"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 13), // "selectedItems"
QT_MOC_LITERAL(4, 45, 15) // "onButtonClicked"

    },
    "SelectionWindow\0selectionMade\0\0"
    "selectedItems\0onButtonClicked"
};
...
void SelectionWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->selectionMade((*reinterpret_cast< QStringList(*)>(_a[1]))); break;
        ...
        {
            using _t = void (SelectionWindow::*)(QStringList );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SelectionWindow::selectionMade)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SelectionWindow::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_SelectionWindow.data,
...
// SIGNAL 0
void SelectionWindow::selectionMade(QStringList _t1)
{
